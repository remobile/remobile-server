...
import {AppList, AppIssue} from 'screens/admin/screens/appManage';
...
export default [
    <Route name='admin' path='/admin' component={Admin}>
        ...
        <Route name='adminAppManage' path='appManage'>
            <Route name='adminAppList' path='appList' component={AppList} onEnter={authenticate} />
            <Route name='adminAppIssue' path='appIssue' component={AppIssue} onEnter={authenticate} />
        </Route>
