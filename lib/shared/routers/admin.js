...
export default [
    <Route name='admin' path='/admin' component={Admin}>
        ...
        <Route name='adminTask' path='task'>
            ...
            <Route name='adminAllTask' path='allTask' component={AllTask} onEnter={authenticate} />
            <Route name='adminToAcceptTask' path='toAcceptTask' component={ToAcceptTask} onEnter={authenticate} />
            <Route name='adminToSubmitTask' path='toSubmitTask' component={ToSubmitTask} onEnter={authenticate} />
            <Route name='adminToAuditTask' path='toAuditTask' component={ToAuditTask} onEnter={authenticate} />
            <Route name='adminPassTask' path='passTask' component={PassTask} onEnter={authenticate} />
        </Route>
