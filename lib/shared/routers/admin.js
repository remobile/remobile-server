...
import {VersionList, VersionIssue} from 'screens/admin/screens/versionManage';
...
export default [
    <Route name='admin' path='/admin' component={Admin}>
        ...
        <Route name='adminVersionManage' path='versionManage'>
            <Route name='adminVersionList' path='versionList' component={VersionList} onEnter={authenticate} />
            <Route name='adminVersionIssue' path='versionIssue' component={VersionIssue} onEnter={authenticate} />
        </Route>
