...
import {NewTask, AllTask, ToAcceptTask, ToSubmitTask, ToAuditTask, PassTask} from 'screens/admin/screens/task';
...
export default [
    <Route name='admin' path='/admin' component={Admin}>
        ...
        <Route name='adminTask' path='task'>
            ...
            <Route name='adminAllTask' path='allTasks' component={AllTask} onEnter={authenticate} />
            <Route name='adminToAcceptTask' path='toAcceptTasks' component={ToAcceptTask} onEnter={authenticate} />
            <Route name='adminToSubmitTask' path='toSubmitTasks' component={ToSubmitTask} onEnter={authenticate} />
            <Route name='adminToAuditTask' path='toAuditTasks' component={ToAuditTask} onEnter={authenticate} />
            <Route name='adminPassTask' path='passTasks' component={PassTask} onEnter={authenticate} />
        </Route>
