    ...
    register(router) {
        ...
        router.subPost('/getPersonalInfo',  (req, res)=>{
            ...
            query({
                ...
                let context = data.data.apiGetPersonalInfo;
                let error = context.error;
                let result = {success: !error, context:!error?context:undefined, msg: error?'接口未授权':undefined};
                router.sendObj(res, result);
            }).catch((err)=>{
                router.sendServerError(res, err);
            });
