...
const addMediaInputType = new GraphQLInputObjectType({
    name: 'addMediaInputType',
    fields: {
...
const addMediaType = new GraphQLObjectType({
    name: 'addMediaType',
    fields: {
        id: {type: GraphQLID},
...
export default {
    ...
    args: {
        data: {
            name: 'data',
            type: new GraphQLNonNull(addMediaInputType)
        }
    },
